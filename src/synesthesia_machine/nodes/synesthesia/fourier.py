    ...
    return (
        NodeDefinition(
                    ...
                    *common_musical_parameter_specs(),
                    ParameterSpec(
                        ...
                        help_text=(
                            ...
                            "none, Hann, or Hamming; windows reduce the ringing caused by the "
                            "image "
                            "edges."
                        ),
                        choices=WINDOWS,
                    ...
                    ParameterSpec(
                        ...
                        RADIAL_MAGNITUDE,
                        help_text=(
                            "Chooses how the frequencies are arranged: Radial spreads them out "
                            "from "
                            "the centre, and Horizontal and Vertical read them along the width or "
                            "the "
                            "height."
                        ),
                    ...
                    ParameterSpec(
                        ...
                        1.0,
                        help_text=(
                            "Highest normalized frequency included; the bands between the minimum "
                            "and "
                            "it become the notes."
                        ),
                        minimum=0.0,
                    ...
                    ParameterSpec(
                        ...
                        PortType.FLOAT,
                        0.0,
                        help_text="Amplitude treated as silent; lower values are not mapped to "
                        "notes.",
                    ),
                    ParameterSpec(
                        "amplitude_ceiling",
                        ...
                        PortType.FLOAT,
                        10.0,
                        help_text="Amplitude treated as full velocity; higher values are not "
                        "louder.",
                    ),
                    ParameterSpec(
                        "dc_exclusion_radius",
                    ...
                    ParameterSpec(
                        ...
                        PortType.FLOAT,
                        90.0,
                        help_text="Percentile used when Band aggregation is Percentile, from 0 to "
                        "100.",
                        minimum=0.0,
                        maximum=100.0,
                        editor_hint=ParameterEditorHint.SLIDER,
                    ...
                    ParameterSpec(
                        ...
                        help_text=(
                            ...
                            "band levels are not scale invariant, so re-tune the amplitude floor "
                            "and "
            ...
            presentation=NodePresentationIntent(
                ...
                "vertically; each frequency band becomes one note and stronger bands play "
                "louder.",
