...
class _PerformanceRun(QObject):
    def __init__(
        ...
        *,
        ...
        self.report: UiDiagnosticReport | None = None
...
def _prepare_runtime_graph(
    ...
    *,
    ...
    source_path = runtime_root / "ui-diagnostic-500x500.mp4"
    ...
    runtime_graph_path = runtime_root / "ui-diagnostic.synmachine.json"
...
def run_diagnostic(
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="synmachine-ui-diagnostic-") as temporary:
