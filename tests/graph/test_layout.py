...
The pure layout algorithms live in the headless graph package; the
scene-integration tests (undo behaviour, overlap, preview clearance) stay in
``tests/ui/test_layout_commands.py``.
"""
