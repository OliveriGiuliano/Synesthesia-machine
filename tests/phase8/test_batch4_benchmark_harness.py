"""Phase 8 batch 4 deterministic reference graph and benchmark harness contracts."""

from __future__ import annotations

from pathlib import Path

from tools.phase8_benchmark import (
    BLUR_ID,
    CHANNEL_DISPLAY_ID,
    NOTE_VISUALIZER_ID,
    SOURCE_ID,
...
def test_checked_reference_serializer_is_reproducible(tmp_path: Path) -> None:
    ...
    assert b"phase8-synthetic-500x500-60fps.mp4" in first
