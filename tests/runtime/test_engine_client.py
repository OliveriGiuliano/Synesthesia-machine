...
import numpy as np
import pytest
from tests.support.graph_factories import ProbeRuntime, RuntimeCounters, make_definition
...
def test_scheduler_resets_only_state_owners_in_selected_source_component() -> None:
    ...
    source_definition = make_definition("test.engine_source", execution_kind=ExecutionKind.SOURCE)
