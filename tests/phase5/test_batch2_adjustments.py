"""Algorithm, metadata, and conformance tests for Phase 5 Batch 2."""
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("synmachine.image.gamma", {"gamma": 0.0}, "gamma must be finite and positive"),
        ("synmachine.image.divide_scalar", {"epsilon": 0.0}, "epsilon must be finite and positive"),
